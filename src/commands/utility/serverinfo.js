...
exports.run = async (client, message, args) => {
  ...
  var embed = new Discord.RichEmbed()
    ...
    .addField(`Users [${message.guild.members.size}]`, `<:online:485069931214536706> **${message.guild.members.filter(m => m.presence.status === 'online').size}** <:invisible:485069893092376579> **${message.guild.members.filter(m => m.presence.status === 'offline').size}** \n<:away:485069825345847296> **${message.guild.members.filter(m => m.presence.status === 'idle').size}** <:dnd:485069860079140864> **${message.guild.members.filter(m => m.presence.status === 'dnd').size}**`, true)
